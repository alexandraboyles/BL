...
try {
    ...
    // ---------------------------------------------------------------------
    // Insert Delivery Address To Onforwarder Address Mapping
    // ---------------------------------------------------------------------
    $pdo->beginTransaction();

    $stmt = $pdo->prepare(
        'INSERT INTO deliveryAddressToOnforwarderAddressMapping (
            id,
            customer_id,
            address_id,
            product_id
    ...
    echo 'Delivery Address To Onforwarder Address Mapping created successfully.';
    ...
    echo 'Failed to create delivery address to onforwarder address mapping: ' . $e->getMessage();
};


//Run: php create_deliveryAddressToOnforwarderAddressMapping.php id=1001 customer_id=64ed8b3e-3247-11f1-92ef-00249b8cd187 address_id=b91e8d30-b0eb-4ca9-911c-750b538d57e7 product_id=702ed0e8-fbca-409e-9d15-7548c10f0ad3