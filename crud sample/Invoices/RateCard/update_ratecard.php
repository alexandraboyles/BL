...
try {
    ...
    echo 'Failed to update rate card: ' . $e->getMessage();
}

//Run: php update_rateCard.php id=1001 customer_id=64ed8b3e-3247-11f1-92ef-00249b8cd187 rates="Premium Shipping Rate" contact_email=finance@globex.com