...
use App\Repository\AddressToInvoiceCustomerMappingRepository;
use InvalidArgumentException;
class AddressToInvoiceCustomerMappingService
{
    private $repo;

    public function __construct()
    {
        $this->repo = new AddressToInvoiceCustomerMappingRepository();
    }
    ...
    public function create(array $data): bool|array
    {
        if ($this->repo->existsById((int)$data['id'])) {
            return ["Address To Invoice Customer Mapping ID is already in use."];
        }
