...
<html>
<head>
    <title>Create Address String</title>
    <style>
...
<h1>Create Address String</h1>
    ...
    <?php endif; ?>
<form method="post" action="/addressstrings">
    <div>
    ...
    <div>
        ...
        <textarea id="text" name="text" rows="4" cols="50" placeholder="Enter text.." required><?= htmlspecialchars($old['text'] ?? '', ENT_QUOTES) ?></textarea>
    </div>
    <br>
    <button type="submit">Save</button>
</form>
<br><br>
<a href="/addressstrings">Back to List</a>
</body>
</html>
